...
export class MainComponent implements OnInit {
  ...
  constructor(
    ...
    window.addEventListener('scroll', () => {
      ...
      if (
        scrollTop + 1 > body_heigth - screen_height &&
        this.counter * this.payload.limit <= this.total_api_data_length
      ) {
  ...
  ngOnInit(): void {
    ...
    this.locationService
      ...
      .then((pos) => {
        ...
        this.apiDataHandling(this.payload);
        console.log(this.apiDataHandling);
      })
      .catch((err) => {
        this.lat = 0;
        this.lng = 0;
